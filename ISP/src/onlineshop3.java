...
public class onlineshop3 extends JFrame implements MouseListener{ 
 ...
 JLabel selectProvince = new JLabel("Sorry, you did not win. Please select your province", SwingConstants.CENTER);
 ...
 double [] taxRates= {1.05, 1.12, 1.13, 1.15, 1.15, 1.05, 1.15, 1.05, 1.13, 1.15, 1.14975, 1.11, 1.05};
 ...
 public onlineshop3() {  
  sushipic = new JLabel(new ImageIcon("sushi2.jpg"));
  ...
  sushipic.setBounds(205, 350 - 565 / 2, 805, 350 + 1000/2);
  ...
  startMenu.add(sushipic);
  System.out.println(sushipic);
